<template>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 32 32">
        <path fill="#fff"
            d="M18,24h-4c-0.552,0-1,0.448-1,1v4c0,0.552,0.448,1,1,1h4c0.552,0,1-0.448,1-1v-4	C19,24.448,18.552,24,18,24z">
        </path>
        <path fill="#fff"
            d="M16,3c-5.846,0-9,4.637-9,9c0,0.552,0.448,1,1,1h4c0.552,0,1-0.448,1-1c0-1.794,1.206-3,3-3	s3,1.206,3,3c0,1.514-1.343,2.625-2.765,3.801C14.719,17.055,13,18.477,13,20.623V22c0,0.552,0.448,1,1,1h4c0.552,0,1-0.448,1-1	v-0.654c0-0.553,0.865-1.276,1.781-2.042C22.561,17.816,25,15.778,25,12C25,6.154,20.363,3,16,3z">
        </path>
        <rect width="4" height="4" x="14" y="25"></rect>
        <path
            d="M16,4c-5,0-8,3.921-8,8h4c0-2.347,1.653-4,4-4s4,1.653,4,4c0,3.86-6,5.176-6,8.623V22h4v-0.654c0-2.532,6-3.798,6-9.346	C24,7.921,21,4,16,4z">
        </path>
    </svg>
</template>