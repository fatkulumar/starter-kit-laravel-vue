...
class EventUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'registration_deadline' => 'required|date|after_or_equal:start_time|before_or_equal:end_time',
            'preliminary_date' => 'nullable|date|after_or_equal:registration_deadline',
            'final_date' => 'nullable|date|after_or_equal:preliminary_date',
            'whatsapp_group_link' => 'required|url',
            'guidebook_link' => 'nullable|url',
            'location' => 'required|string|max:255',
            'is_online' => 'required|boolean',
            'is_publish' => 'required|boolean',
            'is_webinar' => 'required|boolean',
    ...
    public function messages(): array
    {
        return [
            ...
            'registration_deadline.after_or_equal'  => 'Batas registrasi tidak boleh sebelum waktu mulai.',
            'registration_deadline.before_or_equal' => 'Batas registrasi tidak boleh setelah waktu selesai.',
            ...
            'is_publish.required' => 'Is publish online wajib dipilih.',
            'is_publish.boolean' => 'Is publish online harus berupa true/false.',
            'is_webinar.required'    => 'Status webinar wajib dipilih.',
            'is_webinar.boolean'     => 'Status webinar harus berupa nilai benar atau salah.',
            'link_zoom.required_if'  => 'Link Zoom wajib diisi jika status webinar adalah "Ya".',
            'link_zoom.url'          => 'Link Zoom harus berupa URL yang valid.',
            ...
            'round.required' => 'Jumlah babak wajib dipilih.',
            'round.integer'  => 'Jumlah babak harus berupa angka.',
            'round.in'       => 'Jumlah babak hanya boleh 1 atau 2.',
        ];
    }
}
